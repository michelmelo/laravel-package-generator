...
namespace MichelMelo\LaravelPackageGenerator\Generators;

use Illuminate\Config\Repository as Config;
use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Str;
use MichelMelo\LaravelPackageGenerator\Package;
...
class PackageGenerator
{
     ...
     * @param  \MichelMelo\LaravelPackageGenerator\Package  $package
     */
     ...
     * @return MichelMelo\LaravelPackageGenerator\Generators\PackageGenerator
     */
